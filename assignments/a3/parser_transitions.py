...
def minibatch_parse(sentences, model, batch_size):
    ...
    while len(unfinished_parses) > 0:
        batch = min(len(unfinished_parses), batch_size)
        minibatch = unfinished_parses[0:batch]
        ...
        unfinished_parses = [obj for index, obj in enumerate(unfinished_parses) if index not in remove_indices]
